...
def main():
    ...
    names = ['Afghanistan', 'Aland Islands', 'Albania', 'Algeria', 'American Samoa', 'Andorra', 'Angola', 'Anguilla',
             ...
             'Guinea', 'Guinea-Bissau', 'Guyana', 'Haiti', 'Holy See', 'Honduras', 'Hong Kong', 'Hungary', 'Iceland',
    ...
    urls = ['https://lite.ip2location.com/afghanistan-ip-address-ranges',
            ...
            'https://lite.ip2location.com/saint-helena-ascension-and-tristan-da-cunha-ip-address-ranges',
            ...
            'https://lite.ip2location.com/saint-martin-(french-part)-ip-address-ranges',
            ...
            'https://lite.ip2location.com/samoa-ip-address-ranges',
            ...
            'https://lite.ip2location.com/svalbard-and-jan-mayen-ip-address-ranges',
            'https://lite.ip2location.com/sweden-ip-address-ranges',
            'https://lite.ip2location.com/switzerland-ip-address-ranges',
            ...
            'https://lite.ip2location.com/tajikistan-ip-address-ranges',
            ...
            'https://lite.ip2location.com/timor-leste-ip-address-ranges',
            'https://lite.ip2location.com/togo-ip-address-ranges',
            'https://lite.ip2location.com/tokelau-ip-address-ranges',
            'https://lite.ip2location.com/tonga-ip-address-ranges',
            ...
            'https://lite.ip2location.com/vanuatu-ip-address-ranges',
            'https://lite.ip2location.com/venezuela-(bolivarian-republic-of)-ip-address-ranges',
            'https://lite.ip2location.com/viet-nam-ip-address-ranges',
            ...
            'https://lite.ip2location.com/wallis-and-futuna-ip-address-ranges',
